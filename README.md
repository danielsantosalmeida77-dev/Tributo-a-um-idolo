...
<body>
    ...
    <header>
        ...
        <p>O maior esportista do mundo e um exemplo de superação.</p>
         <img src="cristianogol.jpg" alt="" width="200">
    </header>

    <main>
        <aside>
            <h3>Ficha de Identificação</h3> <img src="cr7.jpg" alt="" width="400">
            <p><strong>Nome Completo:</strong> Cristiano Ronaldo dos Santos Aveiro</p>
            <p><strong>Nascimento:</strong> 5 de fevereiro de 1985</p>
            <p><strong>Local:</strong> Funchal, Madeira, Portugal</p>
            <p><strong>Apelido:</strong> CR7</p>
        </aside>
        ...
        <section>
            ...
            <p>Algumas características que definem seu estilo:</p>
            <ul>
        ...
        <section>
            ...
            <p>Fatos sobre sua influência:</p>
            <ol>
            ...
            <p>Para muitos, ele é a <i>definição de superação</i> e <b>perseverança</b>.</p>
        </section>
    </main>

    <footer>
        <hr>
        <p><strong>Fontes:</strong> <a href="https://www.uefa.com">UEFA.com</a> |
            <a href="https://www.fifa.com">FIFA.com</a>
        </p>
        <p>Página criada em: 26 de janeiro de 2026</p>
    </footer>
